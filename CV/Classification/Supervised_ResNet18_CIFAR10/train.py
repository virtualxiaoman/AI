...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=64)  # 4GB 显卡推荐 16-32
...
"""
G:\environment\py\venv\AI\Scripts\python.exe G:\Projects\py\AI\CV\Classification\Supervised\ResNet18_CIFAR10.py 
Device: cuda
Files already downloaded and verified
Files already downloaded and verified

Epoch 1/10
Train loss: 2.0124, acc: 0.2608
Val   loss: 1.4945, acc: 0.4446
Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth

Epoch 2/10
Train loss: 1.3357, acc: 0.5116
Val   loss: 1.1876, acc: 0.5714
Train:   0%|          | 0/782 [00:00<?, ?it/s]Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth

Epoch 3/10
Train loss: 1.0033, acc: 0.6462
Val   loss: 0.9277, acc: 0.6633
Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth

Epoch 4/10
Train loss: 0.8382, acc: 0.7054
Val   loss: 0.7874, acc: 0.7230
Train:   0%|          | 0/782 [00:00<?, ?it/s]Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth

Epoch 5/10
Train:   0%|          | 0/782 [00:00<?, ?it/s]Train loss: 0.7368, acc: 0.7460
Val   loss: 0.8655, acc: 0.7161

Epoch 6/10
Train:   0%|          | 0/782 [00:00<?, ?it/s]Train loss: 0.6836, acc: 0.7648
Val   loss: 0.8865, acc: 0.7126

Epoch 7/10
Train loss: 0.6473, acc: 0.7783
Val   loss: 0.7616, acc: 0.7559
Train:   0%|          | 0/782 [00:00<?, ?it/s]Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth

Epoch 8/10
Train:   0%|          | 0/782 [00:00<?, ?it/s]Train loss: 0.6230, acc: 0.7881
Val   loss: 0.7370, acc: 0.7530

Epoch 9/10
Train:   0%|          | 0/782 [00:00<?, ?it/s]Train loss: 0.5934, acc: 0.7961
Val   loss: 0.9632, acc: 0.6993

Epoch 10/10
Train loss: 0.5912, acc: 0.7986
Val   loss: 0.6151, acc: 0.7932
Saved best model to ../../../Models/CIFAR10/resnet18_minimal\best_supervised.pth
Training finished. Best val acc: 0.7932
Extracting embeddings from best checkpoint...
G:\Projects\py\AI\CV\Classification\Supervised\ResNet18_CIFAR10.py:183: FutureWarning: You are using `torch.load` with `weights_only=False` (the current default value), which uses the default pickle module implicitly. It is possible to construct malicious pickle data which will execute arbitrary code during unpickling (See https://github.com/pytorch/pytorch/blob/main/SECURITY.md#untrusted-models for more details). In a future release, the default value for `weights_only` will be flipped to `True`. This limits the functions that could be executed during unpickling. Arbitrary objects will no longer be allowed to be loaded via this mode unless they are explicitly allowlisted by the user via `torch.serialization.add_safe_globals`. We recommend you start setting `weights_only=True` for any use case where you don't have full control of the loaded file. Please open an issue on GitHub for any issues related to this experimental feature.
  ckpt = torch.load(os.path.join(args.save_dir, "best_supervised.pth"), map_location="cpu")
Saved embeddings: ../../../Models/CIFAR10/resnet18_minimal\embeddings.npy, labels: ../../../Models/CIFAR10/resnet18_minimal\labels.npy
